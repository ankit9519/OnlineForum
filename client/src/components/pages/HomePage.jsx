...
// HomePage component displays a list of questions retrieved from the server.
const HomePage = () => {
    // Redux dispatch function for triggering actions
    const dispatch = useDispatch();

    // Redux state to get the list of questions from the store
    const { questions } = useSelector((state) => state.question);

    // useEffect hook to dispatch the getAllQuestions action on component mount
    useEffect(() => {
        dispatch(getAllQuestions());
    }, [dispatch]);

    // Helper function to format the creation date using moment.js
